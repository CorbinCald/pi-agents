...
5. Check whether user-visible changes have an appropriate entry under the affected package's `## [Unreleased]` changelog section. A contributor may include it; otherwise identify the entry the maintainer must add before merging.
